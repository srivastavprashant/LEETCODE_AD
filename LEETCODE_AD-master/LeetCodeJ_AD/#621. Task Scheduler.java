package LeetCodeJ;// My approach required constant updations in the data still i choose priority queue which was a mistake. Still the code works fine but is
// inefficient. 
